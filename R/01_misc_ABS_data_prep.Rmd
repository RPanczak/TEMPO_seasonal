...
POA <- sf::read_sf("./data/geo/1270055003_poa_2016_aust_shape/POA_2016_AUST.shp") %>% 
...
saveRDS(POA_clean, file = "./data/geo/1270055003_poa_2016_aust_shape/POA_2016_AUST_clean.rds")
...
```{r}
POA <- readRDS(file = "./data/geo/1270055003_poa_2016_aust_shape/POA_2016_AUST_clean.rds")
...
```{r}
ERP_SA2_2018 <- readRDS("./data/ABS/3218.0 Regional Population Growth, Australia, 2017-18/clean/ERP_SA2_2018.Rds")
```

Spatial resolution - **`r nrow(ERP_SA2_2018)`** SA2s.   

```{r}
ggplot(ERP_SA2_2018, aes(x = s_t_name, y = ERP_18)) +
  geom_boxplot() + 
  xlab("") + theme_minimal()
```
